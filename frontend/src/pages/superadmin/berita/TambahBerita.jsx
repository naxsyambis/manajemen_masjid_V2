// frontend/src/pages/superadmin/berita/TambahBerita.jsx
          ...
          <div className="max-w-6xl mx-auto">
            <div className="bg-white rounded-2xl shadow-lg p-10">
              <div className="mb-10 text-center">
                <h1 className="text-4xl font-bold text-gray-800 mb-3">Tambah Berita Baru</h1>
                <p className="text-gray-600 text-lg">Isi informasi berita dengan lengkap dan akurat</p>
              </div>
                  ...
                  <div className="space-y-8">
                    <div className="space-y-4">
                      ...
                      <div className="space-y-2">
                        ...
                        <p className="text-xs text-gray-500">Upload foto gambar berita</p>
                      </div>
                    </div>
                  </div>
