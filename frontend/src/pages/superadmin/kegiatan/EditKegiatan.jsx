...
const EditKegiatan = ({ user, onLogout }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setError('Gagal mengupdate kegiatan. Silakan coba lagi.');
    } finally {
      setLoading(false);
    }
  };
  ...
  return (
    <div className="edit-kegiatan h-screen bg-gradient-to-br from-gray-50 via-white to-gray-100 flex animate-fadeIn">
      ...
      <div className="flex-1 flex flex-col">
        ...
        <div className="main-content p-8 h-full overflow-y-auto space-y-8">
          ...
          {/* Form Edit Kegiatan Modern dan Elegan */}
          <div className="bg-white rounded-[3rem] border border-gray-100 shadow-sm relative overflow-hidden">
            <div className="p-10 lg:p-16">
              <div className="mb-12 text-center">
                <h2 className="text-3xl font-black text-gray-800 uppercase tracking-tighter mb-4">Edit Kegiatan</h2>
