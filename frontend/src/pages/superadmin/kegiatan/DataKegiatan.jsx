...
import { Plus, Edit, Trash2, Eye, AlertTriangle, X, MapPin, Calendar, FileText, Search } from 'lucide-react';
        ...
        <div className="main-content p-6 min-h-screen overflow-y-auto"> {/* Content area */}
          <div className="max-w-7xl mx-auto">
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-8">
              <div>
                <h1 className="text-4xl font-black text-gray-800 mb-2">Data Kegiatan</h1>
                <p className="text-gray-600">Kelola informasi kegiatan dengan mudah dan efisien</p>
              </div>
              <button
            ...
            <div className="bg-white rounded-2xl shadow-2xl overflow-hidden">
              <div className="bg-mu-green p-6 text-white">
                <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center">
                  <div>
                    ...
                    <p className="text-green-100 mt-1">Total: {filteredKegiatans.length} kegiatan</p>
                  </div>
                ...
                <table className="w-full">
                  ...
                  <tbody className="divide-y divide-gray-200">
                    {filteredKegiatans.map((kegiatan, index) => (
                      <tr key={kegiatan.kegiatan_id} className={`hover:bg-gray-50 transition-colors duration-200 ${index % 2 === 0 ? 'bg-white' : 'bg-gray-25'}`}>
                        ...
                        <td className="px-6 py-4 whitespace-nowrap text-center">
                          <div className="flex justify-center space-x-2">
                            <button
                              onClick={() => navigate(`/superadmin/kegiatan/detail/${kegiatan.kegiatan_id}`)}
                            ...
                            <button
                              onClick={() => navigate(`/superadmin/kegiatan/edit/${kegiatan.kegiatan_id}`)}
                            ...
                            <button
                              onClick={() => openDeleteModal(kegiatan)}
              ...
              {filteredKegiatans.length === 0 && searchTerm && (
                <div className="text-center py-16">
                  ...
                  <p className="text-gray-500">Coba kata kunci lain atau tambahkan kegiatan baru.</p>
                </div>
              )}
              ...
              {filteredKegiatans.length === 0 && !searchTerm && (
                <div className="text-center py-16">
                  ...
                  <h3 className="text-xl font-semibold text-gray-600 mb-2">Belum ada data kegiatan</h3>
                  <p className="text-gray-500">Tambahkan kegiatan pertama Anda untuk memulai.</p>
                </div>
              )}
            </div>
          </div>
          ...
          <div className="bg-white rounded-2xl shadow-2xl w-full max-w-md mx-4 transform animate-scale-in">
            ...
            <div className="p-6">
              ...
              <div className="bg-gradient-to-r from-gray-50 to-gray-100 p-4 rounded-xl mb-6 border border-gray-200">
                <h2 className="font-bold text-lg text-gray-800 mb-2">{selectedKegiatan.nama_kegiatan}</h2>
                <div className="space-y-1 text-sm text-gray-600">
                  <p className="flex items-center"><Calendar size={16} className="mr-2" />{new Date(selectedKegiatan.waktu_kegiatan).toLocaleString()}</p>
                  <p className="flex items-center"><MapPin size={16} className="mr-2" />{selectedKegiatan.lokasi}</p>
                </div>
              </div>
