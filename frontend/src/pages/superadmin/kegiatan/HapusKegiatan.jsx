...
const HapusKegiatan = ({ user, onLogout }) => {
  ...
  const confirmDelete = () => {
    showPopup({
      ...
      message: `Yakin ingin menghapus "${kegiatan?.nama_kegiatan}"? Data tidak bisa dikembalikan.`,
      confirmText: 'Hapus',
  ...
  const handleDelete = async () => {
    ...
    try {
      ...
      showPopup({ type: 'error', title: 'Gagal Menghapus', message: 'Gagal menghapus data kegiatan.' });
    } finally {
      setDeleting(false);
    }
  };
    ...
    return (
      <div className="h-screen w-full flex items-center justify-center bg-gradient-to-br from-gray-50 to-gray-100">
        <div className="flex flex-col items-center gap-4">
          ...
          <p className="text-sm font-bold text-mu-green uppercase tracking-wider">Memuat Data...</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="hapus-kegiatan min-h-screen bg-gradient-to-br from-gray-50 to-gray-100">
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="bg-gradient-to-r from-red-50 to-pink-50 border border-red-200 rounded-2xl p-8 mb-8 shadow-lg">
              ...
              <p className="text-red-700 leading-relaxed">
                Pastikan Anda benar-benar ingin menghapus data kegiatan ini. 
                Semua informasi dan data lainnya akan hilang dan tidak dapat dikembalikan.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              ...
              <div className="bg-white rounded-2xl shadow-lg p-8">
                <div className="flex items-center space-x-4 mb-6">
                  ...
                  <h3 className="text-xl font-semibold text-gray-800">Waktu Pelaksanaan</h3>
                </div>
                <p className="text-gray-600">{new Date(kegiatan.waktu_kegiatan).toLocaleString('id-ID')}</p>
              </div>
            </div>
            ...
            <div className="flex justify-center space-x-4 pt-10 mt-10 border-t border-gray-200">
              ...
              <button
                ...
                disabled={deleting}
                className="px-8 py-3 bg-gradient-to-r from-red-500 to-red-600 text-white rounded-xl hover:from-red-600 hover:to-red-700 transition-all duration-200 flex items-center font-medium shadow-lg disabled:opacity-50"
              >
