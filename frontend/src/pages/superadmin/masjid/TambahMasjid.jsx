...
const TambahMasjid = ({ user, onLogout }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setError('Gagal menambahkan masjid. Silakan coba lagi.');
    } finally {
      setLoading(false);
    }
  };
        ...
        <div className="main-content p-8 h-full overflow-y-auto space-y-8">
          ...
          <div className="bg-white p-10 rounded-[3rem] border border-gray-100 shadow-sm relative overflow-hidden">
            <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center mb-10 gap-6">
              <div>
                <h3 className="text-xl font-black text-gray-800 uppercase tracking-tighter">Form Tambah Masjid</h3>
                <p className="text-[10px] text-gray-400 font-bold uppercase tracking-widest mt-1">
                  Isi informasi masjid dengan lengkap dan akurat
                </p>
              </div>
            </div>
