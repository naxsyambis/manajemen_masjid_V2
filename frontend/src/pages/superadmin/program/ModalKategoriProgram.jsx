...
const ModalKategoriProgram = ({ show, onClose, onSuccess, editData }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (editData) {
        ...
        onSuccess(res.data.data.kategori_id);
      }
        ...
        <div className="p-8 space-y-6">
          <div className="space-y-2">
            <label className="text-[10px] font-black text-gray-400 uppercase tracking-widest ml-2">
              {editData ? 'Ubah Nama Kategori' : 'Nama Kategori Baru'}
            </label>
            <input 
              type="text" 
              autoFocus 
              ...
              placeholder="Misal: Kajian Rutin, TPA..." 
              required
            />
          </div>
...
export default ModalKategoriProgram;