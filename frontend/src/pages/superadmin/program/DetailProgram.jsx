...
const DetailProgram = ({ user, onLogout }) => {
  ...
  const fetchProgram = async () => {
    try {
      ...
      setError('Gagal memuat detail program. Silakan coba lagi.');
  ...
  return (
    <div className="detail-program h-screen bg-gradient-to-br from-gray-50 via-white to-gray-100 flex animate-fadeIn">
      ...
      <div className="flex-1 flex flex-col">
        ...
        <div className="main-content p-8 h-full overflow-y-auto space-y-8">
          ...
          {/* Detail Program Modern dan Elegan */}
          <div className="bg-white rounded-[3rem] border border-gray-100 shadow-sm relative overflow-hidden">
            <div className="p-10 lg:p-16">
              <div className="mb-12 text-center">
                <h2 className="text-3xl font-black text-gray-800 uppercase tracking-tighter mb-4">Detail Program</h2>
                <p className="text-gray-600 text-lg">Informasi lengkap tentang program yang dipilih</p>
              </div>
                ...
                <div className="space-y-10">
                  <div className="space-y-6">
                    ...
                    <div className="space-y-3">
                      ...
                      <p className="text-gray-600 text-lg">{program.nama_program}</p>
                      <p className="text-[10px] text-gray-400 font-bold uppercase tracking-widest">ID: {program.program_id}</p>
                    </div>
          ...
          <div className="bg-white rounded-2xl shadow-2xl w-full max-w-md mx-4 transform animate-scale-in">
            ...
            <div className="p-6">
              ...
              <div className="bg-gradient-to-r from-gray-50 to-gray-100 p-4 rounded-xl mb-6 border border-gray-200">
                <h2 className="font-bold text-lg text-gray-800 mb-2">{program.nama_program}</h2>
                <div className="space-y-1 text-sm text-gray-600">
                  <p className="flex items-center"><Calendar size={16} className="mr-2" />{program.jadwal_rutin}</p>
                </div>
              </div>
