// frontend/src/pages/superadmin/program/HapusProgram.jsx
...
import { AlertTriangle, Trash2, X, Calendar, FileText } from 'lucide-react';
            ...
            <div className="bg-gradient-to-r from-red-500 to-red-600 p-10 text-white">
              <div className="flex flex-col lg:flex-row items-start lg:items-center justify-between">
                <div className="flex items-center space-x-6 mb-6 lg:mb-0">
                  ...
                  <div>
                    <h1 className="text-4xl font-bold mb-2">{program.nama_program}</h1>
                    <p className="text-red-100 text-lg">ID Program: {program.program_id}</p>
                  </div>
                </div>
          ...
          <div className="bg-gradient-to-r from-red-50 to-pink-50 border border-red-200 rounded-2xl p-8 mb-8 shadow-lg">
            <div className="flex items-center space-x-4 mb-6">
              ...
              <div>
                ...
                <p className="text-red-600">Menghapus program akan menghilangkan semua data terkait secara permanen.</p>
              </div>
            </div>
            <p className="text-red-700 leading-relaxed">
              Pastikan Anda benar-benar ingin menghapus program ini. Semua informasi akan hilang selamanya dan tidak dapat dikembalikan.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            <div className="bg-white rounded-2xl shadow-lg p-8">
              <div className="flex items-center space-x-4 mb-6">
                ...
                <h3 className="text-xl font-semibold text-gray-800">Jadwal Rutin</h3>
              </div>
              <p className="text-gray-600 leading-relaxed">{program.jadwal_rutin}</p>
            </div>
            ...
            <div className="bg-white rounded-2xl shadow-lg p-8">
              ...
              <p className="text-gray-600 leading-relaxed">{program.deskripsi || 'Tidak ada deskripsi yang tersedia untuk program ini.'}</p>
            </div>
          </div>
          
          <div className="flex justify-center space-x-4 pt-10 mt-10 border-t border-gray-200">
            <button
              onClick={() => navigate(`/superadmin/program/detail/${id}`)}
