...
import { Plus, Edit, Trash2, Eye, AlertTriangle, X, Calendar, FileText, Search, RefreshCcw, AlertCircle } from 'lucide-react';
              ...
              <table className="w-full table-auto">
                ...
                <tbody>
                  {filteredPrograms.map((program, index) => (
                    <tr key={program.program_id} className={`border-t border-gray-100 hover:bg-gradient-to-r hover:from-gray-50 hover:to-white transition-all duration-300 ${index % 2 === 0 ? 'bg-white' : 'bg-gray-50/50'}`}>
