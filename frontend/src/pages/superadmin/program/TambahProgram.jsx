// frontend/src/pages/superadmin/program/TambahProgram.jsx
...
const TambahProgram = ({ user, onLogout }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    setError(null);
    try {
      await axios.post('http://localhost:3000/superadmin/program', formData, {
      ...
      setError('Gagal menambahkan program. Silakan coba lagi.');
    } finally {
      setLoading(false);
    }
  };
  ...
  return (
    <div className="tambah-program h-screen bg-gradient-to-br from-gray-50 via-white to-gray-100 flex animate-fadeIn">
      ...
      <div className="flex-1 flex flex-col">
        ...
        <div className="main-content p-8 h-full overflow-y-auto space-y-8">
          ...
          {/* Form Tambah Program Modern dan Elegan */}
          <div className="bg-white rounded-[3rem] border border-gray-100 shadow-sm relative overflow-hidden">
            <div className="p-10 lg:p-16">
              <div className="mb-12 text-center">
                <h2 className="text-3xl font-black text-gray-800 uppercase tracking-tighter mb-4">Tambah Program Baru</h2>
                <p className="text-gray-600 text-lg">Isi informasi program dengan lengkap dan akurat</p>
              </div>
