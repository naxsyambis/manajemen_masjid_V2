...
import { AlertTriangle, Trash2, X, Calendar, User } from 'lucide-react';
      ...
      <div className="main-content lg:ml-0 p-6 min-h-screen overflow-y-auto">
        <div className="max-w-6xl mx-auto">
                ...
                <div className="flex items-center space-x-6 mb-6 lg:mb-0">
                  <div className="w-20 h-20 bg-white/20 rounded-2xl flex items-center justify-center backdrop-blur-sm">
                    {pengurus.foto_pengurus ? (
                      <img src={`http://localhost:3000${pengurus.foto_pengurus}`} alt="Foto" className="w-16 h-16 object-cover rounded-xl" />
                    ) : (
          ...
          <div className="bg-gradient-to-r from-red-50 to-pink-50 border border-red-200 rounded-2xl p-8 mb-8 shadow-lg">
            <div className="flex items-center space-x-4 mb-6">
              ...
              <div>
                ...
                <p className="text-red-600">Menghapus pengurus akan menghilangkan semua data terkait secara permanen.</p>
              </div>
            </div>
          ...
          <div className="flex justify-center space-x-4 pt-10 mt-10 border-t border-gray-200">
            <button
              onClick={() => navigate(`/superadmin/kepengurusan/detail/${id}`)}
