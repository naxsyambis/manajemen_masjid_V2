...
const EditKepengurusan = ({ user, onLogout }) => {
  ...
  const [formData, setFormData] = useState({
    ...
    periode_mulai: '',
    periode_selesai: '',
    foto_pengurus: null  // Tambahkan untuk preview foto saat ini (selalu defined)
  });
  ...
  const fetchPengurus = async () => {
    try {
      ...
      setFormData({
        nama_lengkap: res.data.nama_lengkap ?? '',  // Gunakan ?? untuk default jika undefined
        ...
        foto_pengurus: res.data.foto_pengurus ?? null  // Untuk preview (selalu defined)
      });
    } catch (err) {
          ...
          <div className="max-w-6xl mx-auto">
            <div className="bg-white rounded-2xl shadow-lg p-10">
              <div className="mb-10 text-center">
                <h1 className="text-4xl font-bold text-gray-800 mb-3">Edit Pengurus</h1>
                      ...
                      <div className="space-y-2">
                        ...
                        <label htmlFor="foto-upload" className="block">
                          <div className="border-2 border-dashed border-gray-300 rounded-lg p-8 text-center cursor-pointer hover:border-mu-green transition-colors">
                            ...
                            ) : formData.foto_pengurus ? (  // Sekarang formData.foto_pengurus selalu defined (null atau string)
                              <div className="space-y-4">
