...
import { Calendar, User, Mail, Building, ArrowLeft, Edit, Trash2, AlertTriangle, X, RefreshCcw, AlertCircle } from 'lucide-react';
...
const DetailTakmir = ({ user, onLogout }) => {
  ...
  const fetchTakmir = async () => {
    try {
      ...
      setError('Gagal memuat detail takmir. Silakan coba lagi.');
  ...
  return (
    <div className="detail-takmir h-screen bg-gradient-to-br from-gray-50 via-white to-gray-100 flex animate-fadeIn">
      ...
      <div className="flex-1 flex flex-col">
        ...
        <div className="main-content p-8 h-full overflow-y-auto space-y-8">
          ...
          {/* Detail Takmir Modern dan Elegan */}
          <div className="bg-white rounded-[3rem] border border-gray-100 shadow-sm relative overflow-hidden">
            <div className="p-10 lg:p-16">
              <div className="mb-12 text-center">
                <h2 className="text-3xl font-black text-gray-800 uppercase tracking-tighter mb-4">Detail Takmir</h2>
                <p className="text-gray-600 text-lg">Informasi lengkap tentang takmir yang dipilih</p>
              </div>
                ...
                <div className="space-y-10">
                  <div className="space-y-6">
                    ...
                    <div className="space-y-3">
                      <label className="block text-sm font-bold text-gray-700 uppercase tracking-wider">Nama Takmir</label>
                      <p className="text-gray-600 text-lg">{takmir.user?.nama}</p>
                      <p className="text-[10px] text-gray-400 font-bold uppercase tracking-widest">ID: {takmir.id}</p>
                    </div>
                    
                    <div className="space-y-3">
                      <label className="block text-sm font-bold text-gray-700 uppercase tracking-wider">Email</label>
                      <div className="flex items-center gap-2">
                        <Mail size={20} className="text-mu-green" />
                    ...
                    <div className="space-y-3">
                      ...
                      <div className="flex items-center gap-2">
                        <Building size={20} className="text-mu-green" />
          ...
          <div className="bg-white rounded-2xl shadow-2xl w-full max-w-md mx-4 transform animate-scale-in">
            ...
            <div className="p-6">
              ...
              <div className="bg-gradient-to-r from-gray-50 to-gray-100 p-4 rounded-xl mb-6 border border-gray-200">
                <h2 className="font-bold text-lg text-gray-800 mb-2">{takmir.user?.nama}</h2>
                <div className="space-y-1 text-sm text-gray-600">
                  <p>Email: {takmir.user?.email}</p>
                  <p>Masjid: {takmir.masjid?.nama_masjid}</p>
                </div>
              </div>
