...
const TambahTakmir = ({ user, onLogout }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setError('Gagal menambahkan takmir. Silakan coba lagi.');
    } finally {
      setLoading(false);
    }
  };
  ...
  return (
    <div className="tambah-takmir h-screen bg-gradient-to-br from-gray-50 via-white to-gray-100 flex animate-fadeIn">
      ...
      <div className="flex-1 flex flex-col">
        ...
        <div className="main-content p-8 h-full overflow-y-auto space-y-8">
          ...
          {/* Form Tambah Takmir Modern dan Elegan */}
                  ...
                  <div className="space-y-10">
                    <div className="space-y-6">
                      ...
                      <div className="space-y-3">
                        ...
                        <p className="text-sm text-gray-500">Password minimal 8 karakter, harus mengandung huruf besar, kecil, angka, dan karakter khusus</p>
                      ...
                      <div className="space-y-3">
                        ...
                        <p className="text-sm text-gray-500">Ulangi password untuk konfirmasi</p>
