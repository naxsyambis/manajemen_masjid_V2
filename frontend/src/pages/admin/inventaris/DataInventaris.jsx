    ...
    <div className="p-4 space-y-10 animate-fadeIn bg-[#fdfdfd]">
      ...
      <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-6 border-b border-gray-100 pb-8">
        ...
        <div className="flex gap-3">
          <Button
            onClick={openTambah}
            className="text-white !rounded-2xl !py-5 !px-10 !bg-mu-green shadow-xl shadow-green-200 hover:translate-y-[-4px] transition-all flex items-center"
          >
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        <div className="stat-card-hover transition-all hover:scale-105">
          <StatCard
            title="Kondisi Layak"
            value={items.filter(i => i.kondisi === 'baik').length}
            ...
            <tbody className="divide-y divide-gray-50">
              {loading ? (
                ...
                <tr key={item.inventaris_id} className="group hover:bg-mu-green/[0.03] transition-all duration-300 cursor-default">
                  <td className="p-8">
                    <span className="text-sm font-black text-gray-700 uppercase tracking-tighter group-hover:text-mu-green transition-colors">
                      {item.nama_barang}
                    </span>
                  </td>
